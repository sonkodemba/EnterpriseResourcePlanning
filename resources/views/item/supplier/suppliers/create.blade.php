                    ...
                    <div class="form-group row">
                        <div class="col-sm-10" >
                            <select name="category_id" id="departmentId" class="selectpicker" data-style="select-with-transition" title="departmentTitle">
                               <option selected> ----- Select Supplier Category------</option>
...
{{--                             <label for="post" class="col-sm-2 col-form-label">Upload</label>--}}
                         ...
                         <div class="form-group row">
                             <div class="file col-sm-10">
                                 <input type="file" name="tin_certificate" class="custom-file-input" id="exampleInputFile">
                                 <label class="custom-file-label" for="exampleInputFile">TIN Certificate </label>
                             </div>
                         </div>
                     <div class="form-group">
